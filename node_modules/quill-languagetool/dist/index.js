...
var C__Users_b_hollstein_Projekte_quillLanguagetool_node_modules_lodash_clonedeep = createCommonjsModule(function (module, exports) {
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright jQuery Foundation and other contributors <https://jquery.org/>
...
var C__Users_b_hollstein_Projekte_quillLanguagetool_node_modules_lodash_isequal = createCommonjsModule(function (module, exports) {
/**
 * Lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright JS Foundation and other contributors <https://js.foundation/>
...
(function (AttributeMap) {
    function compose(a = {}, b = {}, keepNull = false) {
        ...
        let attributes = C__Users_b_hollstein_Projekte_quillLanguagetool_node_modules_lodash_clonedeep(b);
        if (!keepNull) {
    ...
    function diff(a = {}, b = {}) {
        ...
        const attributes = Object.keys(a)
            ...
            .reduce((attrs, key) => {
            if (!C__Users_b_hollstein_Projekte_quillLanguagetool_node_modules_lodash_isequal(a[key], b[key])) {
...
class Delta {
    ...
    push(newOp) {
        ...
        newOp = C__Users_b_hollstein_Projekte_quillLanguagetool_node_modules_lodash_clonedeep(newOp);
        if (typeof lastOp === 'object') {
            ...
            if (C__Users_b_hollstein_Projekte_quillLanguagetool_node_modules_lodash_isequal(newOp.attributes, lastOp.attributes)) {
            ...
            if (otherIter.peekType() === 'insert') {
                ...
                if (otherOp.retain) {
                    ...
                    if (!otherIter.hasNext() &&
                        C__Users_b_hollstein_Projekte_quillLanguagetool_node_modules_lodash_isequal(delta.ops[delta.ops.length - 1], newOp)) {
            ...
            while (length > 0) {
                ...
                switch (component[0]) {
                    ...
                    case diff_1.EQUAL:
                        ...
                        if (C__Users_b_hollstein_Projekte_quillLanguagetool_node_modules_lodash_isequal(thisOp.insert, otherOp.insert)) {
...
function removeSuggestionBoxes(quillEditor) {
    ...
    var deltasWithoutSuggestionBoxes = deltas.ops.map(function (delta) {
        if (delta.attributes && delta.attributes.ltmatch) {
            return __assign(__assign({}, delta), { attributes: __assign(__assign({}, delta.attributes), { ltmatch: null }) });
        }
        return delta;
    });
    // @ts-ignore
...
var C__Users_b_hollstein_Projekte_quillLanguagetool_node_modules_hyperscriptAttributeToProperty = attributeToProperty;
...
var C__Users_b_hollstein_Projekte_quillLanguagetool_node_modules_hyperx = function (h, opts) {
  if (!opts) opts = {};
  var concat = opts.concat || function (a, b) {
    return String(a) + String(b)
  };
  if (opts.attrToProp !== false) {
    h = C__Users_b_hollstein_Projekte_quillLanguagetool_node_modules_hyperscriptAttributeToProperty(h);
  }
...
var dom = function (document) {
  ...
  var exports = C__Users_b_hollstein_Projekte_quillLanguagetool_node_modules_hyperx(nanoHtmlCreateElement, {
    comments: true,
...
var raw = typeof window !== 'undefined'
  ? rawBrowser
  : rawServer;
...
var PopupManager = /** @class */ (function () {
    ...
    PopupManager.prototype.handleSuggestionClick = function (suggestion) {
        ...
        var rule = this.parent.matches.find(function (r) { return r.offset === offset && r.length === length && r.rule.id === ruleId; });
        if (!rule) {
...
var LoadingIndicator = /** @class */ (function () {
    ...
    LoadingIndicator.prototype.startLoading = function () {
        ...
        if (this.parent.params.showLoadingIndicator) {
            var loadingIndicator = browser(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n        <div class=\"quill-lt-loading-indicator\">\n          <div class=\"quill-lt-loading-indicator-spinner\"></div>\n        </div>\n      "], ["\n        <div class=\"quill-lt-loading-indicator\">\n          <div class=\"quill-lt-loading-indicator-spinner\"></div>\n        </div>\n      "])));
            this.currentLoader = loadingIndicator;
            (_b = this.parent.quill.root.parentElement) === null || _b === void 0 ? void 0 : _b.appendChild(loadingIndicator);
        }
    };
...
var QuillLanguageTool = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, fetch(this.params.server + "/v2/check", {
                                method: "POST",
                                headers: {
    ...
    QuillLanguageTool.prototype.getApiParams = function () {
        var paramsObject = __assign({ text: this.quill.getText(), language: this.params.language }, this.params.apiOptions);
        return Object.keys(paramsObject)
            .map(function (key) { return key + "=" + encodeURIComponent(paramsObject[key]); })
            .join("&");
    };
